...
class NumberBondAdditionSingleDigit implements NumberBond {
  int _first = -1;
  int _second = -1;
  int _result = -1;
  ...
  NumberBond generateWithPrevious(NumberBond? previous) {
    while (_first == -1 || (previous as NumberBondAdditionSingleDigit)._first == _first) {
      _generate();
    }
    return this;
  }
